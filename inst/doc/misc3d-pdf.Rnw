...
The IDTF is superior to IDTF in that color and transparency are supported.
...
as shown in Figure \ref{fig:nmix-color}. We need to save the contour surfaces
<<eval=false>>=
saveTrianglesAsIDTF(conts, "nmix-color.idtf")
@ 
...
\begin{figure}[h]
  ...
  \includemovie[3Dlights=CAD,
                ...
                3Droll=-46.5,
%                3Dgetview,
                3Droo=80]{4in}{4in}{nmix-color.u3d}
...
aconts <- g1(40,5)
saveTrianglesAsIDTF(aconts, "nmix-alpha.idtf")
@ 
\begin{figure}[h]
  \centering
  \includemovie[3Dlights=CAD,
                ...
                3Droll=-46.5,
%                3Dgetview,
                3Droo=80]{4in}{4in}{nmix-alpha.u3d}
